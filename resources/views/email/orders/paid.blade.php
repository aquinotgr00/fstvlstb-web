...
<title>EMAIL RESI PENGIRIMAN</title>
<style type="text/css">
				...
				<tr>
					...
					<td align="center" st-image="banner-image">
						<table cellpadding="0" cellspacing="0" border="0"> 
  							<tr> 
							<a target="_blank" href="#"><img width="600" border="0" height="600" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="img/banner.png" class="banner"></a>
                          	</tr>
                      </table>
					</td>
				</tr>
					...
					<td>
						...
						<tr>
							<td style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #000000; text-align:center; " st-content="fulltext-content">
								 Pesanan Kamu sudah berhasil kami kirim
							</td>
						</tr>
						<tr>
							<td width="100%" height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
						...
						<tr>
							<td style="font-family: Helvetica, arial, sans-serif; font-size: 30px; font-weight: 600; color: #ff0000; text-align:center; line-height: 30px;" st-title="fulltext-heading">{{ $transaction->tracking_number }}</td>
						</tr>
						<tr>
							<td width="100%" height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
						</tr>
						<tr>
							<td style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #000000; text-align:center;" st-content="fulltext-content">
								Silahkan dipantau agar sampai tujuan dengan selamat
							</td>
						</tr>
						<tr>
							<td style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #000000; text-align:center;" st-content="fulltext-content">
								Jika sudah sampai, sebarkan kabar baik itu di Sosial Media kamu
							</td>
						</tr>
						<tr>
							<td style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #000000; text-align:center;" st-content="fulltext-content">
