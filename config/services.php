...
return [
    ...
    */
    ...
    'facebook' => [
        ...
        'redirect' => env('FACEBOOK_REDIRECT','https://staging-env.fstvlst.id/facebook/callback'), // Your application route used to redirect users back to your app after authentication
